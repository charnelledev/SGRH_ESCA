 @extends('layouts.admin.layouts-admin')
   ...
   <div class="max-w-5xl mx-auto p-6 sm:p-8 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 min-h-screen">
       <div class="flex justify-between items-center mb-8">
           <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">Créer un nouvel historique</h2>
       ...
       @include('admin.historique_employes.form', ['employes' => $employes, 'emplois' => $emplois, 'employeSelectionne' => $employeSelectionne])
   </div>
   @endsection