    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.html" class="lg:hidden">
                <img class="dark:hidden w-12 h-12 sm:w-8 sm:h-8 object-contain" src="{{ asset('images/WhatsApp.jpg') }}"
                    alt="Logo" />
                <img class="hidden dark:block w-12 h-12 sm:w-8 sm:h-8 object-contain" src="{{ asset('images/WhatsApp.jpg') }}"
                    alt="Logo" />
            </a>
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/user/telechargement76.jpg') }}
                  ...
                  <span class="block">
                    ...
                    >
                      ...
                      <span class="font-medium text-gray-800 dark:text-white/90"
                        >pour  modifié un emploiyer</span
                      >
                    </span>
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="
                      {{ asset('assets/images/user/telechargement85.jpg') }}
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src=" {{ asset('assets/images/user/telechargement78.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/user/telechargement79.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/user/telechargement80.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
                  ...
                  <span class="block">
                    ...
                    >
                      <span class="font-medium text-gray-800 dark:text-white/90"
                        >charnelle kengne</span
                      >
                     a soumis une permission 
                      <span class="font-medium text-gray-800 dark:text-white/90"
                        >pour modifier les information de l'employer</span
                      >
                    </span>
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/user/telechargement82.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    <img src="{{ asset('assets/images/user/telechargement83.jpg') }}" 
                  ...
                  <span class="block">
                    ...
                    >
                      <span class="font-medium text-gray-800 dark:text-white/90"
                        >Philips</span
                      >
                      a soumis une permission pour  modifié un emploiyer 
                      <span class="font-medium text-gray-800 dark:text-white/90"
                        >pour modifier un employer</span
                      >
                    </span>
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                        ...
                        <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                            <img src="{{ asset('assets/images/user/1000181062.jpg') }}" alt="User" />
                        </span>

                        <span class="text-theme-sm mr-1 block font-medium"> charnelle </span>
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                            ...
                            <li>
                                <a href="{{ route('admin.profil.settings') }}"
                                    class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                    <svg class="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <a href="{{ route('admin.profil.support') }}"
                                    class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                    <svg class="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
