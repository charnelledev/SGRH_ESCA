<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
    <div class="flex justify-between">
        <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
                Démographie des Employes
            </h3>
            <p class="mt-1 text-theme-sm text-gray-500 dark:text-gray-400">
                Nombre d'employe par région
            </p>
        </div>
    ...
    <div
        class="border-gray-200 my-6 overflow-hidden rounded-2xl border bg-gray-50 px-4 py-6 dark:border-gray-800 dark:bg-gray-900 sm:px-6"
    >
        <div
            id="mapOne"
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="w-full max-w-8 items-center rounded-full">
                        <img src="{{ asset('images/region/region-' . ($index + 1) . '.svg') }}" alt="{{ $region['name'] }}" />
                    </div>
                    <div>
                ...
                <div class="flex w-full max-w-[140px] items-center gap-3">
                    ...
                    >
                        <div
                            class="absolute left-0 top-0 flex h-full w-[{{ $region['percentage'] }}%] items-center justify-center rounded-sm bg-brand-500 text-xs font-medium text-white"
                        ></div>
                    </div>
