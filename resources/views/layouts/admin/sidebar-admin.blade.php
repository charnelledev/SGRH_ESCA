<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
   ...
   <img
  class="dark:hidden w-12 h-12 sm:w-8 sm:h-8 object-contain"
  src="{{ asset('images/WhatsApp.jpg') }}"
  alt="Logo"
/>
<img
  class="hidden dark:block w-12 h-12 sm:w-8 sm:h-8 object-contain"
  src="{{ asset('images/WhatsApp.jpg') }}"
  alt="Logo"
/>
    ...
    <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
       ...
       {{ Request::is('/') ? 'bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white' }}">
                        @if (Request::is('/'))
                            <span
                                class="absolute left-0 top-0 bottom-0 w-1 bg-blue-600 dark:bg-blue-400 rounded-tr-md rounded-br-md"></span>
                        @endif
                        <!-- Icône maison -->
                        <svg class="h-5 w-5 text-blue-500" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3 9l9-7 9 7v11a2 2 0 01-2 2h-4a2 2 0 01-2-2v-6H9v6a2 2 0 01-2 2H3a2 2 0 01-2-2V9z" />
                        </svg>
               ...
               {{ Request::is('admin/employes*') ? 'bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white' }}">
                        ...
                        <svg class="h-5 w-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2"
                                d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-2a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
    ...
    <div class="pb-4">
        ...
        <div class="mt-6 flex justify-center">
            <div
                class="h-1 w-10 rounded-full bg-gradient-to-r from-gray-300 via-gray-500 to-gray-300 dark:from-gray-600 dark:via-gray-400 dark:to-gray-600">
            </div>
        </div>
    </div>
</aside>
